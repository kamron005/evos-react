            ...
            <Form noValidate validated={validated} className="bg-dark text-light p-5 needs-validation" id="form" onSubmit={handleSubmit}>
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="first-name" className="text-capitalize">Ism</Form.Label>
                    ...
                    <Col md={6}>
                        <Form.Label htmlFor="last-name" className="text-capitalize">Familiya</Form.Label>
                ...
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="phone-number" className="text-capitalize">Telefon nomer</Form.Label>
                ...
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="date">Kun</Form.Label>
                    ...
                    <Col md={6}>
                        <Form.Label htmlFor="guests" className="text-capitalize">Mehmonlar soni</Form.Label>
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="comments">Fikrlar</Form.Label>
